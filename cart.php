            ...
            <div class="header_top">
              ...
              <button class="btn btn-outline-success" name="search_botton" type="submit">Search</button>
                ...
                <span>text</span>
                            ...
                            <a href="./supplier/home.php" class="cart-link">
                                    ...
                                    if (1==1) {
                                        ...
                                        for ($count = 1; $count <= $total; $count++) {
                                            ...
                                            if ($result) {
                                                ...
                                                <td><img class='' src='./productimages/<?php echo $product_image; ?>' style='height:60px; width:60px;' alt='...' /></td>
                                                <td><?php echo $no_of_products; ?> </td>
                                                <td>Rs.<?php echo $product_price; ?></td>
                                                <td>Rs.<?php echo $total_price; ?></td>
                                                <td>
                                                        <a href='./cart_items_delete.php?product_id=<?php echo $product_id; ?>' class='btn btn-danger btn-sm delete btn-flat' onclick="return confirm('You Want To  Remove The Item From The Cart?')"><i class='fa fa-trash'></i> Delete</a>
                                                    </td>
                                            </tr>
