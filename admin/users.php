                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="./delete_user.php?user_id=<?php echo $row['user_id'] ?>" class='btn btn-danger btn-sm delete btn-flat' onclick="return confirm('Are you want to delete?')"><i class='fa fa-trash'></i> Delete</a>
                                                    </td>
                                                </tr>
                                        <?php
                                            }
